...
public class AicsApp {

    private static final Logger log = LoggerFactory.getLogger(AicsApp.class);

    private final Environment env;

    public AicsApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AicsApp.class);
