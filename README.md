...
To optimize the AICS application for production, run:
...
[Using UAA for Microservice Security]: http://www.jhipster.tech/documentation-archive/v4.8.2/using-uaa/[Using JHipster in development]: http://www.jhipster.tech/documentation-archive/v4.8.2/development/
